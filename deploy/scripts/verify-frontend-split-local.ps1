...
Invoke-Step "verify cloud frontend split wiring" {
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud app download package reads must track request identity" "cloud app download package reads must track request identity"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud app download package reads must compare request scope" "cloud app download package reads must compare request scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud app download package load must block duplicate reads and ignore stale responses" "cloud app download package load must block duplicate reads and ignore stale responses"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud drive app package reads must track request identity" "cloud drive app package reads must track request identity"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud drive app package reads must compare request scope" "cloud drive app package reads must compare request scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud drive app package reads must block duplicate reads and ignore stale responses" "cloud drive app package reads must block duplicate reads and ignore stale responses"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web dashboard reads must track request identity" "cloud web dashboard reads must track request identity"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web dashboard health reads must compare request scope" "cloud web dashboard health reads must compare request scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web dashboard health reads must block duplicates and ignore stale responses" "cloud web dashboard health reads must block duplicates and ignore stale responses"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web dashboard overview reads must compare auth scope" "cloud web dashboard overview reads must compare auth scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web dashboard overview reads must block duplicates and ignore stale responses" "cloud web dashboard overview reads must block duplicates and ignore stale responses"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web dashboard usage history reads must compare auth scope" "cloud web dashboard usage history reads must compare auth scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web dashboard usage history reads must block duplicates and ignore stale responses" "cloud web dashboard usage history reads must block duplicates and ignore stale responses"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web dashboard reads must invalidate auth scope changes" "cloud web dashboard reads must invalidate auth scope changes"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web dashboard auth scope changes must clear previous account data" "cloud web dashboard auth changes must clear stale account data"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud drive dashboard refreshes must force reads after explicit refresh or storage mutations" "cloud drive dashboard refreshes must force reads"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web share mutations must ignore stale auth scope" "cloud web share mutations must ignore stale auth scope"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web identity session reads must track request identity" "cloud web identity session reads must track request identity"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web identity session reads must compare auth and revoked-filter scope" "cloud web identity session reads must compare auth and revoked filter scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web identity session reads must block duplicate same-scope requests" "cloud web identity session reads must block duplicate same-scope requests"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web identity session reads must ignore stale responses" "cloud web identity session reads must ignore stale responses"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web identity session reads must invalidate when auth scope changes" "cloud web identity session reads must invalidate auth scope changes"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web profile auth scope changes must clear account dialogs and sessions" "cloud web profile auth changes must clear stale account UI"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web identity session actions must use synchronous loading guards and force refreshes" "cloud web identity session actions must use synchronous guards"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web identity session modal must surface refresh pending state" "cloud web identity session modal must surface refresh pending state"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page save folder reads must track request identity" "cloud share page save folder reads must track request identity"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page save folder reads must compare auth scope" "cloud share page save folder reads must compare auth scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page save folder reads must invalidate when auth scope changes" "cloud share page save folder reads must invalidate auth scope changes"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page save folder reads must block duplicate same-scope requests" "cloud share page save folder reads must block duplicate same-scope requests"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page save folder reads must ignore stale responses" "cloud share page save folder reads must ignore stale responses"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share save mutations must ignore stale auth share scope" "cloud share save mutations must ignore stale auth share scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page reads must track request identity" "cloud share page reads must track request identity"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page status reads must compare share code scope" "cloud share page status reads must compare share code scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page status reads must block duplicates and ignore stale responses" "cloud share page status reads must block duplicates and ignore stale responses"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page detail reads must compare auth access and status scope" "cloud share page detail reads must compare auth access and status scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page detail reads must invalidate when prerequisites change" "cloud share page detail reads must invalidate prerequisites"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page detail reads must block duplicates and ignore stale responses" "cloud share page detail reads must block duplicates and ignore stale responses"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page must clear stale status and detail when share code changes" "cloud share page must clear stale status and detail when share code changes"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page password checks must ignore stale share scope" "cloud share page password checks must ignore stale share scope"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page downloads must ignore stale auth share scope" "cloud share page downloads must ignore stale auth share scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share page downloads must invalidate on auth access scope changes" "cloud share page downloads must invalidate auth access scope changes"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share create thumbnail reads must track request identity" "cloud share create thumbnail reads must track request identity"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share create thumbnail reads must compare selected auth and target scope" "cloud share create thumbnail reads must compare selected auth and target scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud share create thumbnail reads must ignore stale responses" "cloud share create thumbnail reads must ignore stale responses"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web downloads must ignore stale auth scope" "cloud web downloads must ignore stale auth scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web downloads must invalidate transfers on auth scope changes" "cloud web downloads must invalidate auth scope changes"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web file preview reads must track request identity" "cloud web file preview reads must track request identity"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web file preview reads must compare auth target and version scope" "cloud web file preview reads must compare auth target and version scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web file preview reads must ignore stale responses" "cloud web file preview reads must ignore stale responses"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web file preview reads must invalidate when auth or visible scope changes" "cloud web file preview reads must invalidate when auth or visible scope changes"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web uploads must ignore stale auth scope" "cloud web uploads must ignore stale auth scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web uploads must block duplicate batches with synchronous guards" "cloud web uploads must block duplicate batches"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web uploads must abort and clear tasks on auth scope changes" "cloud web uploads must abort and clear tasks on auth scope changes"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web storage mutations must ignore stale auth scope" "cloud web storage mutations must ignore stale auth scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web folder option reads must track request identity" "cloud web folder option reads must track request identity"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web folder option reads must compare auth scope" "cloud web folder option reads must compare auth scope"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web folder option reads must block duplicate same-scope requests" "cloud web folder option reads must block duplicate same-scope requests"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web folder option reads must ignore stale responses" "cloud web folder option reads must ignore stale responses"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web folder option reads must invalidate when auth scope changes" "cloud web folder option reads must invalidate auth scope changes"
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web explorer auth scope changes must clear previous account navigation and files" "cloud web explorer auth changes must clear stale files"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web storage dialogs must clear account drafts when auth scope changes" "cloud web storage dialogs must clear stale account drafts"
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud drive page must pass auth scope to storage dialogs" "cloud drive page must scope storage dialogs by account"
    ...
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web current-user reads must track request identity" "cloud web current-user reads must track request identity"
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web current-user reads must compare current stored token" "cloud web current-user reads must compare current stored token"
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web auth token updates must keep ref and state synchronized" "cloud web auth token updates must keep ref and state synchronized"
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web current-user reads must ignore stale responses" "cloud web current-user reads must ignore stale responses"
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web account switches must replace stale principals before applying new auth scope" "cloud web account switches must replace stale principals"
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web current-user reads must invalidate on logout and profile updates" "cloud web current-user reads must invalidate on logout and profile updates"
    ...
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web profile session revocation must track request identity" "cloud web profile session revocation must track request identity"
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web profile session revocation must compare auth and target scope" "cloud web profile session revocation must compare auth and target scope"
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web profile session revocation must ignore stale auth responses" "cloud web profile session revocation must ignore stale auth responses"
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web profile session revocation must invalidate when auth scope changes" "cloud web profile session revocation must invalidate when auth scope changes"
    ...
    Require-Contains "webApp/scripts/verify-session-sync.mjs" "cloud web profile mutations must ignore stale auth scope" "cloud web profile mutations must ignore stale auth scope"
    ...
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console users reads must track request identity" "cloud console users reads must track request identity"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console users reads must compare auth admin scope" "cloud console users reads must compare auth admin scope"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console users reads must block duplicate reads and ignore stale responses" "cloud console users reads must block duplicate reads and ignore stale responses"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console users reads must invalidate auth admin scope changes" "cloud console users reads must invalidate auth admin scope changes"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console users refreshes must force reads after header refresh or quota mutations" "cloud console users refreshes must force reads after header refresh or quota mutations"
    ...
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console quota mutations must ignore stale auth admin scope" "cloud console quota mutations must ignore stale auth admin scope"
    ...
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console APK reads must track request identity" "cloud console APK reads must track request identity"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console APK reads must compare auth admin public scope" "cloud console APK reads must compare auth admin public scope"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console APK reads must block duplicate reads and ignore stale responses" "cloud console APK reads must block duplicate reads and ignore stale responses"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console APK mutations must invalidate stale package reads" "cloud console APK mutations must invalidate stale package reads"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console APK mutations must ignore stale auth admin scope" "cloud console APK mutations must ignore stale auth admin scope"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console APK admin reads must invalidate auth admin scope changes" "cloud console APK admin reads must invalidate auth admin scope changes"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console APK refreshes must force paired admin and public package reads" "cloud console APK refreshes must force paired admin and public package reads"
    ...
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console operations reads must track request identity" "cloud console operations reads must track request identity"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console operations reads must compare auth admin query scope" "cloud console operations reads must compare auth admin query scope"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console operations reads must block duplicate reads and ignore stale responses" "cloud console operations reads must block duplicate reads and ignore stale responses"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console operations reads must invalidate auth admin scope changes" "cloud console operations reads must invalidate auth admin scope changes"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console operations refreshes must force reads after explicit refresh or query changes" "cloud console operations refreshes must force reads after explicit refresh or query changes"
    ...
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console profile mutations must ignore stale auth scope" "cloud console profile mutations must ignore stale auth scope"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console auth scope changes must clear the profile dialog draft" "cloud console auth changes must clear profile drafts"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console auth scope changes must clear quota drafts and user data" "cloud console auth changes must clear quota drafts"
    Require-Contains "sysManage/scripts/verify-console-boundary.mjs" "cloud console auth scope changes must clear APK upload drafts and admin data" "cloud console auth changes must clear APK drafts"
    ...
    Require-Contains "sysManage/scripts/verify-session-sync.mjs" "cloud console current-user reads must track request identity" "cloud console current-user reads must track request identity"
    Require-Contains "sysManage/scripts/verify-session-sync.mjs" "cloud console current-user reads must compare current stored token" "cloud console current-user reads must compare current stored token"
    Require-Contains "sysManage/scripts/verify-session-sync.mjs" "cloud console auth token updates must keep ref and state synchronized" "cloud console auth token updates must keep ref and state synchronized"
    Require-Contains "sysManage/scripts/verify-session-sync.mjs" "cloud console current-user reads must ignore stale responses" "cloud console current-user reads must ignore stale responses"
    Require-Contains "sysManage/scripts/verify-session-sync.mjs" "cloud console account switches must replace stale principals before applying new auth scope" "cloud console account switches must replace stale principals"
    Require-Contains "sysManage/scripts/verify-session-sync.mjs" "cloud console current-user reads must invalidate on logout and profile updates" "cloud console current-user reads must invalidate on logout and profile updates"
    ...
    Require-Contains "webApp/package.json" '"verify:built-boundary": "node scripts/verify-built-boundary.mjs"' "cloud web package must expose the built client boundary verifier"
    ...
    Require-Contains "webApp/package.json" "vite build && npm run verify:built-shell && npm run verify:built-boundary && npm run verify:bundle-size" "cloud web build must verify built shell, published client boundary, and bundle size after vite build"
    ...
    Require-Contains "webApp/scripts/verify-built-boundary.mjs" "/api/admin/" "cloud web built boundary verifier must reject cloud admin API artifacts"
    Require-Contains "webApp/scripts/verify-built-boundary.mjs" "/api/identity/admin/" "cloud web built boundary verifier must reject identity admin API artifacts"
    Require-Contains "webApp/scripts/verify-built-boundary.mjs" "/console/cloud" "cloud web built boundary verifier must reject cloud console route artifacts"
    Require-Contains "webApp/scripts/verify-built-boundary.mjs" "/console/identity" "cloud web built boundary verifier must reject identity console route artifacts"
    Require-Contains "webApp/scripts/verify-built-boundary.mjs" "CLOUD_ADMIN" "cloud web built boundary verifier must reject cloud administrator role artifacts"
