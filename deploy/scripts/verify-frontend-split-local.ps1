...
Invoke-Step "verify cloud frontend split wiring" {
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web APK download panel must use user-facing unavailable copy without upload/admin wording" "cloud web boundary verifier must reject APK upload wording in the user-facing download panel"
