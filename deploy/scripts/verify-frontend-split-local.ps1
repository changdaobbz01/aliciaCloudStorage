...
Invoke-Step "verify cloud frontend split wiring" {
    ...
    Require-Contains "webApp/scripts/verify-client-boundary.mjs" "cloud web shares view must not refresh while a share revocation is pending" "cloud web shares view must avoid refresh while share revocation is pending"
