...
curl_ok "main site identity console login entry" -I "$PUBLIC_BASE_URL/login?returnTo=/console/identity/users"
curl_ok "main site cloud console login entry" -I "$PUBLIC_BASE_URL/login?returnTo=/console/cloud/users"
...
expect_spa_shell "main site identity console login entry" "$PUBLIC_BASE_URL/login?returnTo=/console/identity/users" "Alicia Tools" "/assets/index-"
expect_spa_shell "main site cloud console login entry" "$PUBLIC_BASE_URL/login?returnTo=/console/cloud/users" "Alicia Tools" "/assets/index-"
...
curl_ok "cloudPan app download route" -I "$PUBLIC_BASE_URL/cloudPan/app-download"
...
expect_spa_shell "cloudPan app download route" "$PUBLIC_BASE_URL/cloudPan/app-download" "Alicia 云盘" "/cloudPan/assets/index-"
...
if [[ "$SKIP_CACHE_CHECKS" != "true" ]]; then
    ...
    expect_no_store_index "main site identity console login index" "$PUBLIC_BASE_URL/login?returnTo=/console/identity/users"
    expect_no_store_index "main site cloud console login index" "$PUBLIC_BASE_URL/login?returnTo=/console/cloud/users"
    ...
    expect_no_store_index "cloudPan app download index" "$PUBLIC_BASE_URL/cloudPan/app-download"
